...
public class OrderController {
    ...
    public String getPaymentPort(){
        return restTemplate1.getForObject("http://cloud-provider-consul-payment/getport", String.class);
    }

    @RequestMapping("/getpaymentport2")
    public String getPaymentPort2(){
        return restTemplate2.getForObject("http://localhost:1301/getport", String.class);
    }
    ...
    public String getPaymentLB(){
        List<ServiceInstance> instances = discoveryClient.getInstances("cloud-provider-consul-payment"); //获取某服务的各个分部的情况
